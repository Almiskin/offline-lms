...
The full automated suite currently passes 80 tests across 9 test suites. The latest audit corrections are represented in the quiz, material, synchronization, upload, bulk-import, and frontend UI tests listed above.
