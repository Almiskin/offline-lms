...
The full automated suite currently passes 73 tests across 8 test suites. The latest audit corrections are represented in the quiz, material, synchronization, and upload tests listed above.
